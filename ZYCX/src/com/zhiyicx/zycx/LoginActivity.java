...
public class LoginActivity extends Activity implements OnClickListener {
    ...
    private ImageView mQuickRegister, mForgetPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuickRegister.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(LoginActivity.this, RegisterFrament.class);
        ...
        mForgetPassword.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(LoginActivity.this, SetNewPd.class);
                startActivity(intent);
            }
        });
    ...
    public void onClick(View v) {
        String userName = mAutoLoginUserName.getText().toString().trim();//URLEncoder.encode(PublicMethods.encryptName(mAutoLoginUserName.getText().toString().trim(), "THINKSNS"));
        String userPassWd = mloginUserpd.getText().toString().trim();//URLEncoder.encode(PublicMethods.encryptPassWd(PublicMethods.encryptMD5(mloginUserpd.getText().toString().trim()), "THINKSNS"));
    ...
    private void initView() {
        mAutoLoginUserName = (AutoCompleteTextView) findViewById(R.id.et_loginUserName);
        mloginUserpd = (EditText) findViewById(R.id.et_loginUserpd);
        mBtnLogin = (Button) findViewById(R.id.btn_login);
        mQuickRegister = (ImageView) findViewById(R.id.iv_quickregister);
        mForgetPassword = (ImageView) findViewById(R.id.iv_forgetpassword);
        mQQLogin = (ImageView) findViewById(R.id.iv_qq_login);
        mRenrenLogin = (ImageView) findViewById(R.id.iv_renren_login);
        mShareTencentWeb = (ImageView) findViewById(R.id.iv_share_tencentweb);
        mShareSinaWeb = (ImageView) findViewById(R.id.iv_share_sinaweb);
            ...
            try {
                switch (msg.what) {
                    case 1:
                        ...
                        break;
                    case 2:
                        authorizeResult = oauth.authorize(data.getString("username"),
                                data.getString("password"),
                                data.getString("type_uid"),
                                data.getString("type"));
                        loginedUser = users.show(authorizeResult);
                        loginedUser.setToken(authorizeResult.getToken());
                        loginedUser.setSecretToken(authorizeResult.getSecretToken());
