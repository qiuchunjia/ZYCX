...
public class WeiboListAdapter extends SociaxListAdapter {
	...
	public WeiboListAdapter(BaseListFragment context, ListData<SociaxItem> data) {
		super(context, data);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			weiboDataItem.username = (TextView) convertView.findViewById(R.id.user_name);
			weiboDataItem.weiboCtime = (TextView) convertView.findViewById(R.id.weibo_ctime);
			weiboDataItem.weiboContent = (TextView) convertView.findViewById(R.id.weibo_content);
			weiboDataItem.header = (ImageView) convertView.findViewById(R.id.user_header);
			weiboDataItem.weiboFrom = (TextView) convertView.findViewById(R.id.weibo_from);
	...
	private void setZhanCount(View view, int pos) {
		// Log.d("LISTViewAppend","Weibo feed id =" + weibo.getWeiboId() +"Zhan
		// count=" + weibo.getZhanCount());
	...
	private class ZhanClickListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			if (!app.isLogin()) {
				app.startActivity_qcj(context, LoginActivity.class, null);
				return;
			}
			String url = MyConfig.WEB_ZAN_URL + Utils.getTokenString(mListContext.mContext) + "&feed_id="
					+ getItem(mPos).getWeiboId();
			if (getItem(mPos).isZhan())
				url = MyConfig.WEB_DELZAN_URL + Utils.getTokenString(mListContext.mContext) + "&feed_id="
						+ getItem(mPos).getWeiboId();
	...
	public ListData<SociaxItem> refreshHeader(SociaxItem obj)
		...
		// ListData<SociaxItem> weiboDatas =
		// getApiStatuses().friendsHeaderTimeline((Weibo) obj, PAGE_COUNT);
	...
	public ListData<SociaxItem> refreshFooter(SociaxItem obj)
			throws VerifyErrorException, ApiException, ListAreEmptyException, DataInvalidException {
		// return getApiStatuses().friendsFooterTimeline((Weibo) obj,
		// PAGE_COUNT);
	...
	public ListData<SociaxItem> refreshNew(int count)
		...
		// ListData<SociaxItem> weiboDatas =
		// getApiStatuses().friendsTimeline(count);
