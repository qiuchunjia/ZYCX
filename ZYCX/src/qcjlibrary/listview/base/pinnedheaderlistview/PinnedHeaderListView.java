...
public class PinnedHeaderListView extends BaseListView {
	...
	public void stepToNextActivity(AdapterView<?> parent, View view, int position,
	...
	public void stepToNextActivity(Model sendData, Class<? extends Activity> activityClass) {
		if (mActivity instanceof BaseActivity) {
			BaseActivity activity = ((BaseActivity) mActivity);
